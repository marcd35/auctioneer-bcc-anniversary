--[[
	...
	Version: 2.5.6771 (SwimmingSeadragon)
	Revision: $Id: SlideMain.lua 6771 2022-01-25 11:42:44Z none $
...
LibStub("LibRevision"):Set("$URL: SlideBar/SlideMain.lua $","$Rev: 6771 $","6.0.DEV.", 'auctioneer', 'libs')
...
function private.GUI()
	...
	local category = Settings.RegisterCanvasLayoutCategory(config, "Norganna SlideBar")
	...
	local reset = CreateFrame("Button", "SlideBarResetButton", frame.config, "UIPanelButtonTemplate")
	config.reset = reset
	reset:SetWidth(160)
