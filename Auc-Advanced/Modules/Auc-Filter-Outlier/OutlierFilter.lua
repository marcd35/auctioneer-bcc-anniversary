--[[
	...
	Version: 2.5.6752 (SwimmingSeadragon)
	Revision: $Id: OutlierFilter.lua 6752 2022-01-25 11:42:44Z none $
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Filter-Outlier/OutlierFilter.lua $", "$Rev: 6752 $")
