--[[
	...
	Version: 2.5.6741 (SwimmingSeadragon)
	Revision: $Id: ScanButton.lua 6741 2022-01-25 11:42:44Z none $
...
function private.HookAH()
	...
	private.buttons.stop.count = private.buttons.stop:CreateFontString(nil, "OVERLAY")
	private.buttons.stop.count:SetFontObject(GameFontHighlight)
	...
	msg.Done = CreateFrame("Button", "", msg, "UIPanelButtonTemplate")
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-ScanButton/ScanButton.lua $", "$Rev: 6741 $")
