--[[
	...
	Revision: $Id: ConfirmSellUI.lua 6755 2022-01-25 11:42:44Z none $
...
function lib.ASCConfirmContinue()
	...
	for key, itemdata in pairs(lib.vendorlist) do
		...
		if linkType == "item" and not get("util.automagic.vidignored"..iID) then --will be nil if not on ignore list
			...
			C_Container.UseContainerItem(itemdata[4], itemdata[5])
		end
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-AutoMagic/ConfirmSellUI.lua $", "$Rev: 6755 $")
