--[[
	...
	Revision: $Id: Auc-Util-AutoMagic.lua 6755 2022-01-25 11:42:44Z none $
...
for i = 1, NUM_CHAT_WINDOWS do
    ...
    if frame and frame:GetScript("OnHyperlinkClick") then
        frame:HookScript("OnHyperlinkClick", lib.ClickLinkHook)
    end
end
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-AutoMagic/Auc-Util-AutoMagic.lua $", "$Rev: 6755 $")
