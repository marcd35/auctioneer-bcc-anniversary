...
function private.HookAH()
	...
	local check = CreateFrame("CheckButton", nil, AuctionFrameBrowse, "UICheckButtonTemplate")
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-CompactUI/CompactUI.lua $", "$Rev: 6756 $")
