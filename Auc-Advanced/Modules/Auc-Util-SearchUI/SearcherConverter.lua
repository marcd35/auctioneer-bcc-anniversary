--[[
	...
	Revision: $Id: SearcherConverter.lua 6750 2022-01-25 11:42:44Z none $
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-SearchUI/SearcherConverter.lua $", "$Rev: 6750 $")
