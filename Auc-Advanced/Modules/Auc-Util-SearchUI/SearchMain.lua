...
if Enchantrix and Enchantrix.Storage and Enchantrix.Util then
	...
	local _, _, _, _, reason = C_AddOns.GetAddOnInfo("Enchantrix") -- check it's actually possible to load
...
function private.MakeGuiConfig()
	...
	gui.frame.purchase:SetWidth(100)
	...
	gui.frame.ignoreperm:SetWidth(100)
	...
	gui.frame.snatch:SetPoint("BOTTOMLEFT", gui, "BOTTOMLEFT", 650, 35)
	gui.frame.snatch:SetText("Snatch")
	gui.frame.snatch:SetWidth(100)
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-SearchUI/SearchMain.lua $", "$Rev: 6750 $")
