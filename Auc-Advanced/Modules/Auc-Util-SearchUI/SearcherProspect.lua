--[[
	...
	Revision: $Id: SearcherProspect.lua 6750 2022-01-25 11:42:44Z none $
...
-- prospecting does not exist in Classic, does in BC and later, but AucAdvanced.Const.Classic isn't initialized yet
if isClassic and isClassic < 2 then return end
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-SearchUI/SearcherProspect.lua $", "$Rev: 6750 $")
