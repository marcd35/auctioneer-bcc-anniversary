--[[
	...
	Revision: $Id: CoreManifest.lua 6733 2022-01-25 11:42:44Z none $
...
elseif tocVersion < MINIMUM_TOC or (MINIMUM_BUILD and tonumber(build) < MINIMUM_BUILD) then
	print("Auctioneer requires Classic game client version "..MINIMUM_CLIENT.." or higher.")
	lib.ABORTLOAD = "Incorrect WoW client version"
end
...
lib.RegisterRevision("$URL: Auc-Advanced/CoreManifest.lua $", "$Rev: 6733 $")
