--[[
	...
	Version: 1,4
	Revision: $Id: nTipHelper.lua 6738 2022-01-25 11:42:44Z none $
...
do -- tooltip class definition
	local libTT = LibStub("LibExtraTip_-1", true)
	if not libTT then
...
LibStub("LibRevision"):Set("$URL: Auc-Advanced/Libs/TipHelper/nTipHelper.lua $","$Rev: 6738 $","5.12.DEV.", 'auctioneer', 'libs')
