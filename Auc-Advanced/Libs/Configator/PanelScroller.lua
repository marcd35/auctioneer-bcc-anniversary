--[[
	...
	Revision: $Id: PanelScroller.lua 6736 2022-01-25 11:42:44Z none $
...
LibStub("LibRevision"):Set("$URL: Auc-Advanced/Libs/Configator/PanelScroller.lua $","$Rev: 6736 $","5.1.DEV.", 'auctioneer', 'libs')
