--[[
	...
	Revision: $Id: Configator.lua 6736 2022-01-25 11:42:44Z none $
...
local LIBRARY_VERSION_MINOR = 35
local lib = LibStub:NewLibrary(LIBRARY_VERSION_MAJOR, LIBRARY_VERSION_MINOR)
if not lib then return end

LibStub("LibRevision"):Set("$URL: Auc-Advanced/Libs/Configator/Configator.lua $","$Rev: 6736 $","5.1.DEV.", 'auctioneer', 'libs')
