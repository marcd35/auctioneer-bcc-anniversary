--[[
	...
	Revision: $Id: CoreConst.lua 6733 2022-01-25 11:42:44Z none $
...
if AucAdvanced.Classic == 2 then 
	lib.MAXSKILLLEVEL = 375
	lib.MAXUSERLEVEL = 70
	lib.MAXITEMLEVEL = 130
end
...
if not AucAdvanced.ABORTLOAD then
	...
	if AucAdvanced.Classic then
		lib.AC_ClassIDList = {
			...
			-- LE_ITEM_CLASS_GLYPH, Does not exist in Classic or TBC
			LE_ITEM_CLASS_TRADEGOODS,
			LE_ITEM_CLASS_RECIPE,
			-- LE_ITEM_CLASS_BATTLEPET, Does not exist in Classic or TBC
	...
	lib.AC_PetType2SubClassID = {GetAuctionItemSubClasses(17)}

end

AucAdvanced.RegisterRevision("$URL: Auc-Advanced/CoreConst.lua $", "$Rev: 6733 $")
