...
Enchantrix_RegisterRevision("$URL: Enchantrix/EnxAutoDisenchant.lua $", "$Rev: 6768 $")
...
local function onEvent(...)
	...
	elseif event == "BAG_UPDATE" then
		...
		elseif isState("prompt") and arg1 == auto_de_prompt.bag then
		    ...
		    local link = C_Container.GetContainerItemLink(auto_de_prompt.bag, auto_de_prompt.slot)
...
local function initUI()
	...
	for i = 1, 5 do
		auto_de_prompt.Lines[i] = auto_de_prompt:CreateFontString("AutoDisenchantPromptLine"..i, "OVERLAY")
		if (i == 1) then
...
--		local tex = source:GetNormalTexture()		-- this is returning NIL in 5.0.4
	...
	auto_de_prompt.DummyYes = CreateFrame("Button", "", auto_de_prompt, "UICheckButtonTemplate")
	...
	auto_de_prompt.No = CreateFrame("Button", "AutoDEPromptNo", auto_de_prompt, "UICheckButtonTemplate")
	...
	auto_de_prompt.Ignore = CreateFrame("Button", "AutoDEPromptIgnore", auto_de_prompt, "UICheckButtonTemplate")
