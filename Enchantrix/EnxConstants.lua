--[[
	...
	Revision: $Id: EnxConstants.lua 6768 2022-01-25 11:42:44Z none $
...
Enchantrix_RegisterRevision("$URL: Enchantrix/EnxConstants.lua $", "$Rev: 6768 $")

local const = Enchantrix.Constants


-- need to know early if we're using Classic or Modern version: 11300 is base Classic, 20501 is BC Classic
...
-- need to refine estimates with actual DE results
    ...
    const.baseDisenchantTable = {
     [UNCOMMON] = {
      [const.WEAPON] = {
       ["bounds"] = { 15, 20, 25, 30, 35, 40, 45, 50, 55, 60, 65, 99, 120 },
     ...
     [RARE] = {
        -- weapon lookups will fall back to the armor table
      [const.ARMOR] = {
       ["bounds"] = { 25, 30, 35, 40, 45, 50, 55, 65, 99, 120 },
     ...
     [EPIC] = {
        -- weapon lookups will fall back to the armor table
      [const.ARMOR] = {
       ["bounds"] = { 40, 45, 50, 55, 66, 94, 99, 164 },
