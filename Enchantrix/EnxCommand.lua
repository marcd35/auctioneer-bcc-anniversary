--[[
	...
	Revision: $Id: EnxCommand.lua 6768 2022-01-25 11:42:44Z none $
...
Enchantrix_RegisterRevision("$URL: Enchantrix/EnxCommand.lua $", "$Rev: 6768 $")
	...
	if not Enchantrix.State.Auctioneer_Loaded then
		...
		if not aucLoadPending then
			...
			if not EnchantConfig.displayedAuctioneerWarning then
				...
				DEFAULT_CHAT_FRAME:AddMessage(_ENCH('MesgAuctVersion'));
